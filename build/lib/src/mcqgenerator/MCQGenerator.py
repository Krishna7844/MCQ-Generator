...
#Access the enviroment variables just like you would with os.environ
key = os.getenv("API_KEY")


llm = ChatGoogleGenerativeAI(api_key=key, model="gemini-2.5-flash", temperature=0.5) #temperatue means according to values wo creative behave karta hai
...
quiz_chain = LLMChain(llm=llm, prompt=quiz_generation_prompt, output_key = "quiz", verbose=True) #verbose is used to the whatever happeing during execution
